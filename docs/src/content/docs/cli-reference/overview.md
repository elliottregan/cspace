...
| `cspace context-server` | Stdio MCP server exposing `docs/context/` (launched by Claude via `.mcp.json`, not invoked directly). See [Project Context](/architecture/project-context/). |
